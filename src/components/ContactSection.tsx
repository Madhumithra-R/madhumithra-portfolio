...
const ContactSection = () => {
  const ref = useReveal();
  return (
    <section id="contact" className="relative z-[1] min-h-screen px-5 md:px-16 lg:px-20 py-20 md:py-24 text-center">
      ...
      <div ref={ref} className="reveal max-w-[560px] mx-auto">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-3 justify-center mb-12">
          <a href="mailto:madhumithra@email.com" className="contact-link justify-center">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
            madhumithra@email.com
          </a>
          <a href="#" className="contact-link justify-center">
        ...
        <form className="flex flex-col gap-3.5 text-left" onSubmit={(e) => e.preventDefault()}>
          ...
          <button type="submit" className="btn-cyan mt-2">Send Message</button>
        </form>
      </div>
    </section>
  );
